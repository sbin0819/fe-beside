...
export const calendarGrayViewBox = '0 0 20 20'
export const CalendarGray = () => {
    return (
        <>
            ...
            >
                <path
                    d="M7 11a1 1 0 1 0 0-2 1 1 0 0 0 0 2zM8 13a1 1 0 1 1-2 0 1 1 0 0 1 2 0zM10 11a1 1 0 1 0 0-2 1 1 0 0 0 0 2zM11 13a1 1 0 1 1-2 0 1 1 0 0 1 2 0zM13 11a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"
                    fill="#87878B"
                />
                <path
                    fillRule="evenodd"
